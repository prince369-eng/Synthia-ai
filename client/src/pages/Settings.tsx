...
function SettingsDataControls() { return <div><SectionHeading icon={ShieldCheck} title="Data controls" description="Synthia protects task records and user-owned attachments with secure workspace data handling." /><div className="mt-6 grid gap-3 sm:grid-cols-2"><SettingsCard title="Task data" detail="Task state, event replay, approvals, and usage records remain available for your workspace history."><p className="text-xs leading-5 text-[#a99a8a]">Deletion and retention tooling is intentionally unavailable until a server-side data-lifecycle workflow is enabled.</p></SettingsCard><SettingsCard title="Files and artifacts" detail="Attachment and deliverable access is checked against the authenticated owner before a signed URL is issued."><p className="text-xs leading-5 text-[#a99a8a]">Internal access credentials and raw file locations are never displayed in Settings.</p></SettingsCard></div></div>; }
