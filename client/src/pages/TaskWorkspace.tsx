...
import { TaskLearningPanel, TaskOfficeExportMenu } from "@/components/TaskOfficeControls";
...
type WorkspaceTab = "screen" | "website" | "code" | "terminal" | "files" | "timeline" | "plan" | "proof" | "learning" | "operations";
...
export default function TaskWorkspace({ replayMode = false }: { replayMode?: boolean }) {
  ...
  const tabs: Array<{ id: WorkspaceTab; label: string; icon: typeof Code2 }> = [{ id: "screen", label: "Screen", icon: MonitorDot }, { id: "website", label: "Website", icon: Globe2 }, { id: "code", label: "Code", icon: Code2 }, { id: "terminal", label: "Terminal", icon: TerminalSquare }, { id: "files", label: "Files", icon: FolderTree }, { id: "timeline", label: "Timeline", icon: ListTree }, { id: "plan", label: "Plan", icon: FileText }, { id: "proof", label: "Proof", icon: ShieldCheck }, { id: "learning", label: "Review", icon: BookOpenText }, { id: "operations", label: "Operations", icon: AlertTriangle }];
